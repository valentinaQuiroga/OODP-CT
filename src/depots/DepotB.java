...
public class DepotB extends Depot {
    ...
    //Constructor
    public DepotB(int id, String company, int nativeStock, int externalStock1, int externalStock2, int budget, int productPrice, int deliveryPrice){
        this.id = id;
    ...
    public String toString() {
        return "Depot " + id + " from Company B {" +
